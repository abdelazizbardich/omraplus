...
Route::middleware(['detect.device'])->group(function () {
    ...
    Route::get('/offer/{flight:id}', [App\Http\Controllers\OfferController::class, 'index'])->name('offer');
    ...
    Route::get('/checkout/{flight:id}', [App\Http\Controllers\CheckoutController::class, 'checkout'])->name('checkout');
