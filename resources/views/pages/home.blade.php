...
@section('content')
    ...
    <div class="container m-auto flex justify-between items-start">
        ...
        <div class="w-4/12 flex items-start justify-center">
            <x-atoms.text-offer-card icon="{{ Vite::asset('resources/images/customer-offer.webp') }}" :description="__('Exclusive Packages and Seasonal Offers at Competitive Prices')" :title="__('Special packages and offers throughout the year')"></x-atoms.text-offer-card>
        </div>
        <div class="w-4/12 flex items-start justify-center">
