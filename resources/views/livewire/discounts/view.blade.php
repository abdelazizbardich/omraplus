...
<div class="w-full flex gap-2" wire:discount-created="$refresh">
    @foreach ($discounts as $discount)
        <div class="">
            ...
            <label for="discount-{{ $discount->id }}" class="w-full flex flex-col gap-3 justify-center items-center bg-white rounded-lg p-3 peer-checked:bg-gradient-to-br  peer-checked:from-yellow-300  peer-checked:to-yellow-500 cursor-pointer">
