...
<div class="w-full flex gap-2" wire:pricing-created="$refresh">
    @foreach ($pricings as $pricing)
        <div class="">
            ...
            <label for="pricing-{{ $pricing->id }}" class="w-full flex flex-col gap-3 justify-center items-center bg-white rounded-lg p-3 peer-checked:bg-gradient-to-br  peer-checked:from-yellow-300  peer-checked:to-yellow-500 cursor-pointer">
