            ...
            <div class="rounded-lg shadow-md bg-white mb-6">
                ...
                <div class="flex items-center justify-between px-3 mb-3 pb-3">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <input type="text" readonly class="text-center outline-none rounded-none p-0 border-none select-none bg-white text-black me-2 flex items-center w-6 justify-center font-black h-6 aspect-square" value="1">
                        <span class="rounded-full bg-white border text-black-500 shadow-md cursor-pointer border-black-200 text-black me-2 flex items-center justify-center font-black h-8 aspect-square">+</span>
                    </div>
                </div>
            ...
            <div class="rounded-lg shadow-md bg-white mb-6">
                ...
                <div class="flex items-center justify-between px-3 mb-3 pb-3 gap-12">
                    <label class="form-control w-full">
                        ...
                        <input type="text" placeholder="{{__('first name')}}" class="input input-bordered border-black-200 w-full" />
                    </label>
                    <label class="form-control w-full">
                        <div class="label">
                            <span class="label-text">{{__('last name')}}</span>
                        </div>
                        <input type="text" placeholder="{{__('last name')}}" class="input input-bordered border-black-200 w-full" />
                    </label>
                </div>
                <div class="flex items-center justify-between px-3 mb-3 pb-3 gap-12">
                    <label class="form-control w-full">
                        ...
                        <input type="text" placeholder="{{__('city')}}" class="input input-bordered border-black-200 w-full" />
                    </label>
                    <label class="form-control w-full">
                        <div class="label">
                            <span class="label-text">{{__('phone')}}</span>
                        </div>
                        <input type="text" placeholder="{{__('phone')}}" class="input input-bordered border-black-200 w-full" />
                    </label>
                    <label class="form-control w-full">
                        <div class="label">
                            <span class="label-text">{{__('email')}}</span>
                        </div>
                        <input type="text" placeholder="{{__('email')}}" class="input input-bordered border-black-200 w-full" />
                    </label>
                </div>
            </div>
            <div class="rounded-lg shadow-md bg-white mb-6">
