    ...
    <div class="w-full max-w-6xl mx-auto p-4">
        <div class="flex flex-col md:flex-row">
            <div class="w-full md:w-1/2 p-4">
                <h2 class="text-xl md:text-3xl font-semibold text-indigo-600 mb-2">{{ __('index.Welcome to') }} <strong>{{ config('app.name') }}</strong>!</h2>
                ...
                <p class="text-gray-600">{{__('index.in')}} <strong>{{ config('app.name') }}</strong>، {{ __('index.The comfort and satisfaction of our customers is our top priority. Feel free to reach out to us at any time - we are here for you.') }}</p>
            </div>
