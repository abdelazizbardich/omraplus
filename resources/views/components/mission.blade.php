<div class="w-full">
    <div class="mb-16 w-full">
        ...
        <h2 class="text-4xl font-bold mb-6">{{__('index.mission title')}}</h2>
        <p class="text-base mb-4 w-6/12">{{__('index.about.omraplus')}}</p>
        <p class="text-base mb-4 w-6/12">{{__('index.about.experience')}}</p>
        <p class="text-base mb-4 w-6/12">{{__('index.about.mission')}}</p>
    </div>
