...
<span class="border border-emerald-500 rounded-full py-1 px-4  text-sm font-semibold absolute -top-8 start-0 block z-10">{{__('Best Seller')}}</span>
    <div class="border bg-white border-black-200 hover:shadow-md duration-300 rounded-3xl w-full h-full mt-3 overflow-hidden relative">
        ...
        <div class="p-3">
            ...
            <div class="text-justify line-clamp-3">
                {!! $data->description !!}
            </div>
            <hr class="my-3 opacity-30">
            ...
            <div class="flex justify-between gap-2">
                <a href="{{ whatsappLink('fast_booking',route('offer', $data->id)) }}" class="text-nowrap flex-row flex-nowrap text-black-900 text-base flex font-black justify-center bg-gradient-to-l from-emerald-500 to-emerald-600 items-center btn bg-emerald-550 flex-1 hover:shadow-lg">
