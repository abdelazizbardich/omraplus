<div class="w-full h-full bg-black-1100 pt-12 text-light m-0">
    <div class="container opacity-95 m-auto flex justify-between items-center border-b pb-6 border-light">
        <div class="w-3/12 border-e border-light p-6 ps-0">
    ...
    <div class="container opacity-95 m-auto flex justify-between items-center border-b py-8 border-light">
        <div class="w-3/12">
