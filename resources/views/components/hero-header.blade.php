    ...
    <div class="border border-white relative rounded-lg p-6 container m-auto z-20 -mb-32">
        ...
        <div class="relative z-20  w-full mx-auto">
            <form action="" class="rounded-2xl w-12/12 mx-auto bg-emerald-500 bg-gradient-to-l from-emerald-550 to-emerald-500 flex items-center p-6 flex items-center justify-between shadow-2xl">
                ...
                <div class="w-2/12">
                    <x-select :id="'select-omra'" name="omra" :label="__('index.chose the omra')" :options=$umrahs></x-select>
                </div>
                <div class="w-2/12">
                    <x-select :id="'count'" name="month" :label="__('index.travlers count')" :options='[["id"=>1,"value"=>1],["id"=>2,"value"=>2],["id"=>3,"value"=>3],["id"=>4,"value"=>4],["id"=>5,"value"=>5],["id"=>6,"value"=>6],["id"=>7,"value"=>7],["id"=>8,"value"=>8]]'></x-select>
                </div>
                <div class="w-4/12">
                    <x-select :id="'program'" name="month" :label="__('index.programe')" :options=$programs></x-select>
                </div>
                <div class="w-1/12">
