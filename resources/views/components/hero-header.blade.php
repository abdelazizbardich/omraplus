    ...
    <div class="border border-white relative rounded-lg p-6 container m-auto z-20 -mb-32">
        ...
        <div class="relative z-20  w-full mx-auto">
            <form action="" class="rounded-2xl w-12/12 mx-auto bg-emerald-500 bg-gradient-to-l from-emerald-550 to-emerald-500 flex items-center p-6 flex items-center justify-between shadow-2xl">
                ...
                <div class="w-2/12">
                    <x-select name="month" :label="__('chose the omra')" :options="[__('January Umrah'), __('February Umrah'), __('March Umrah'), __('April Umrah'), __('May Umrah'), __('June Umrah'), __('July Umrah'), __('August Umrah'), __('September Umrah'), __('October Umrah'), __('November Umrah'), __('December Umrah')]"></x-select>
                </div>
                <div class="w-2/12">
                    <x-select name="month" :label="__('travlers count')" :options="[1,2,3,4,5,6]"></x-select>
                </div>
                <div class="w-2/12">
                    <x-select name="month" :label="__('programe')" :options="[]"></x-select>
                </div>
                <div class="w-2/12">
                    <x-select name="month" :label="__('')" :options="[]"></x-select>
                </div>
                <div class="w-1/12">
