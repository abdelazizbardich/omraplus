    ...
    <div class="p-2 text-gray-900 bg-white rounded-lg shadow-md flex justify-between items-center">
        <div class="flex items-center gap-8">
            <label class="btn btn-circle swap swap-rotate">
                <input type="checkbox" hidden class="hidden menu-toggle" false/>
        ...
        <a href="{{ route('home') }}" class="p-3 cursor-pointer hover:text-gray-700 flex items-center justify-center">
            <img src="{{ Vite::asset('resources/images/home.png') }}" alt="{{ __('index.Home') }}"  class="me-3 h-6 opacity-90 cursor-pointer hover:opacity-100 aspect-square">
        </a>
