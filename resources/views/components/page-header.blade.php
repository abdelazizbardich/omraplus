<div class="w-full bg-blue-1000 page-header h-auto text-center bg-cover bg-center py-12" style="background-image: url({{ $background ? $background : Vite::asset('resources/images/kaaba-1.jpg') }});">
