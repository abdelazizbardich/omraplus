<div class="w-full border border-black-200 p-3 rounded-3xl hover:shadow-md duration-300">
    <div class="rounded-3xl overflow-hidden bg-white mb-3 hover:shadow-md duration-300">
        <a href="#">
            <img src="{{ Vite::asset('resources/images/site-avatar.jpg') }}" class="h-60 object-cover w-full border border-black-200" alt="blog thumbnail">
        </a>
    </div>
    <div class="">
        ...
        <div class="flex items-center justify-between gap-2">
            <div class="flex items-center justify-start gap-2">
                ...
                <div class="flex flex-col justify-center items-start">
                    <span class="text-sm font-black">Michael Foster</span>
