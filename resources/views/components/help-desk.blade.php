<div class="flex gap-12">
    ...
    <div class="lg:w-6/12 xl:w-6/12">
        ...
        <p class="block mb-10 lg:text-xl xl:text-2xl">{{ __('We are Here to Help') }}</p>
        <div class="flex mb-3 gap-6">
            ...
            <div class="w-full">
                <div class="xl:text-2xl lg:text-xl rounded-full mb-4 bg-blue-50 xl:px-5 lg:px-2 lg:py-1 xl:py-3 w-fit block flex flex-row justify-between items-center w-full">
                    <span class="flex-1 font-black me-2 block">{{ __('cell pohne') }}</span>
                ...
                <div class="xl:text-2xl lg:text-xl rounded-full mb-4 bg-blue-50 xl:px-5 lg:px-2 lg:py-1 xl:py-3 w-fit block flex flex-row justify-between items-center w-full">
                    <span class="flex-1 font-black me-2 block">{{ __('home pohne') }}</span>
                    <span class="mx-3 block">:</span>
                    <span class="font-bold ms-15 block" dir="ltr">+212 6 63 61 85 36</span>
                </div>
            </div>
        ...
        <div class="flex">
            <div class="w-4/12 flex flex-row justify-start items-center gap-3">
                ...
                <span class="flex flex-col gap-3">
                    <span class="text-3xl font-black text-nowrap inline-block">{{ __('Support') }} <span dir="ltr">24/7/365</span></span>
                    <span class="text-2xl font-black text-nowrap inline-block">{{ __('Live Chat') }}</span>
                </span>
            </div>
        </div>
    </div>
