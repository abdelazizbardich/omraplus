<div class="relative w-full h-full mt-8">
    <span class="bg-black-900 rounded-full py-1 px-3 text-white text-xs font-semibold absolute -top-7 start-0 block z-10">{{__('Best Seller')}}</span>
    <div class="z-10 hover:shadow-md duration-300 border border-black-200 bg-white featured rounded-3xl w-full h-full mt-3 overflow-hidden relative">
        ...
        <div class="p-3">
            <div class="flex">
                <span class="bg-black-900 p-2 aspect-square me-2 rounded-md text-white block text-xs text-center font-bold flex items-center justify-center flex-col leading-2"><span>7</span><span>{{__('Days')}}</span></span>
                <h1 class="font-black text-xs w-full rounded-full w-fit m-auto">عمرة شعبان - من 19 فبراير إلى 06 مارس - عبر الخطوط السعودية</h1>
            </div>
