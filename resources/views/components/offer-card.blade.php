<div class="relative w-full h-full mt-8">
    ...
    <div class="border border-slate-600 rounded-3xl w-full h-full mt-3 overflow-hidden relative">
        <div class="w-full relative">
            <img src="{{ Vite::asset('resources/images/umrah.jpg') }}" class="w-full h-80" alt="umrah">
            <span class="bg-yellow-500 w-20 h-20 rounded-md text-white block text-xl text-center font-bold flex items-center justify-center flex-col leading-6 absolute start-4 bottom-4"><span>7</span><span>{{__('Days')}}</span></span>
        </div>
        <div class="p-3">
