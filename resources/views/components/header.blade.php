<header>
    ...
    <div class="w-12/12 h-24 bg-blue-950" id="header-main-bar">
        <div class="container h-full mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center">
                <a href="{{ route('home') }}" class="px-8 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn header-nav-btn-active"><em class="fa fa-home text-3xl" title="{{__('Home')}}"></em></a>
                <a href="{{ route('home') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn">{{__('Omra packs')}}</a>
