    ...
    <div class="w-12/12 h-14 bg-yellow-500" id="header-top-bar">
        <div class="container h-full mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('home') }}" class="me-4 text-sm">{{__('index.Booking instructions')}}</a>
                <a href="{{ route('home') }}" class="me-4 text-sm">{{__('index.Privacy policy')}}</a>
                ...
                @if(Auth::check())
                    <a href="{{ route('login') }}" class="ms-4 text-sm font-black">{{__('index.Dashboard')}}</a>
                @else
    ...
    <div class="w-12/12 h-24 bg-blue-950" id="header-main-bar">
        <div class="container h-full mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('home') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Omra packs') header-nav-btn-active @endif">{{__('index.Omra packs')}}</a>
                ...
                <a href="{{ route('home') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Personalizd omra') header-nav-btn-active @endif">{{__('index.Personalizd omra')}}</a>
                <a href="{{ route('home') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Hadj 2025') header-nav-btn-active @endif">{{__('index.Hadj 2025')}}</a>
                <a href="{{ route('home') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Request e-visa') header-nav-btn-active @endif">{{__('index.Request e-visa')}}</a>
