<header>
    <div class="w-12/12 h-14 bg-yellow-500" id="header-top-bar">
        <div class="container h-full mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('booking-instructions') }}" class="me-4 text-sm">{{__('index.Booking instructions')}}</a>
    ...
    <div class="w-12/12 h-24 bg-blue-950" id="header-main-bar">
        <div class="container h-full mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center">
                <a href="{{ route('home') }}" class="px-8 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Home') header-nav-btn-active @endif"><em class="fa fa-home text-3xl" title="{{__('index.Home')}}"></em></a>
                <a href="{{ route('omra-packs') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Omra packs') header-nav-btn-active @endif">{{__('index.Omra packs')}}</a>
                <a href="{{ route('ramadan-omra') }}" class="relative px-4 border-solid border-e h-24 flex flex-col items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Ramadan omra') header-nav-btn-active @endif">
                ...
                <a href="{{ route('personalizd-omra') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Personalizd omra') header-nav-btn-active @endif">{{__('index.Personalizd omra')}}</a>
                <a href="{{ route('hadj-2025') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Hadj 2025') header-nav-btn-active @endif">{{__('index.Hadj 2025')}}</a>
                <a href="{{ route('visa') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Request e-visa') header-nav-btn-active @endif">{{__('index.Request e-visa')}}</a>
                <a href="{{ route('contact-us') }}" class="px-4 border-solid border-e h-24 flex items-center justify-center border-blue-1000 text-white header-nav-btn @if($active === 'Contact us') header-nav-btn-active @endif">{{__('index.Contact us')}}</a>
            </div>
        </div>
    </div>
</header>